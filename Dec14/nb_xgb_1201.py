...
w = np.genfromtxt("/data/scratch/lingrui/sec_temp/Sec/test_all.weight" , delimiter=',')
print(len(w))
...
train_X_df.to_csv("./test_all_xgb_input.csv",index=False)
...
out_df.to_csv("./test_all_prediction.csv", index=False)
